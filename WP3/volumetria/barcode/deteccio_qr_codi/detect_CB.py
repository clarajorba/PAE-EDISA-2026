...
CARPETA_DADES = Path("..") / ".." / "data"
CARPETA_ENTRADA = CARPETA_DADES / "fotos_capturades"
CARPETA_SORTIDA = "demo_output_detected"
NOM_MANIFEST = CARPETA_DADES / "etiquetes_magatzem_manifest.csv"
...
def registrar_codis_globals(
    ...
    for det in deteccions:
        ...
        producte_registrable = es_producte_registrable(det, estat)
...
def main() -> int:
    ...
    try:
        estanteries_valides, codi_a_producte = carregar_manifest(manifest_path)
